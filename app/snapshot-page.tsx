          ...
          <div className="change-grid">
            <article>
              ...
              <p>
                ...
                Backend und eine persistente synthetische Datenbank hinter
                einem schmalen öffentlichen Webzugang. Anwendungen und
                Datenbank bleiben intern; Produktionsdaten und
                Produktionsverantwortung gehören ausdrücklich nicht dazu.
              </p>
            </article>
            <article>
              ...
              <p>
                ...
                WebSocket, negative Netzwerk- und Zugriffsfälle sowie ein
                vollständiger Aktivierungsrollback wurden am realen Zielsystem
                geprüft. Der laufende Umbau auf einen bereinigten fachlichen
                Datenstand ist dagegen noch kein veröffentlichter Ist-Zustand.
              </p>
            </article>
            <article className="assessment-card">
              ...
              <p>
                ...
                Sobald jedoch TLS, Proxy-Vertrauen, Browserinteraktivität,
                negative Sicherheitsgrenzen und Rollback gemeinsam zählen,
                reicht ein flüchtiger Aufbau nicht mehr. Die Umgebung ist
                deshalb vertretbar, solange ihr Umfang klein bleibt und jeder
                zusätzliche Dienst eine eigene Vertrauensentscheidung bleibt.
              </p>
            </article>
          </div>
          ...
          {isCurrentSnapshot && (
            <article className="practice-card lab-card">
              ...
              <p>
                ...
                Release-Artefakte, synthetische Persistenz, echter Browser und
                ein endlicher Aktivierungs- und Rollbackpfad.
              </p>
              ...
              <p className="card-limit">
                ...
                Produktionsklon. Der aktuell vorbereitete Wechsel von rein
                synthetischen auf bereinigte fachliche Testdaten bleibt bis zu
                Review, Apply und Smoke ausdrücklich laufende Arbeit.
              </p>
            </article>
          )}
        </div>
